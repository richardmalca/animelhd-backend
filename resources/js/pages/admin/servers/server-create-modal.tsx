            ...
            <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto">
                <form onSubmit={submit}>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Crea un nuevo servidor de video para la plataforma.
                        </DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-4 py-4">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="embed">Dominio Base (URL)</Label>
                            <Input
                                id="embed"
                                value={data.embed}
                        ...
                        <div className="space-y-4 rounded-md border p-4 bg-muted/20">
                            ...
                            <div className="flex items-center justify-between">
                                <Label htmlFor="show_on_web_desktop" className="text-sm">Mostrar en Web (Desktop)</Label>
                                <Switch
                                    id="show_on_web_desktop"
                                    checked={data.show_on_web_desktop}
                                    onCheckedChange={(checked) => setData('show_on_web_desktop', checked)}
                                />
                            </div>
                            <div className="flex items-center justify-between">
                                <Label htmlFor="show_on_web_mobile" className="text-sm">Mostrar en Web (Móvil)</Label>
                                <Switch
                                    id="show_on_web_mobile"
                                    checked={data.show_on_web_mobile}
                                    onCheckedChange={(checked) => setData('show_on_web_mobile', checked)}
                                />
                            </div>
                            <div className="flex items-center justify-between">
                                <Label htmlFor="show_on_app" className="text-sm">Mostrar en App Android</Label>
                                <Switch
                                    id="show_on_app"
